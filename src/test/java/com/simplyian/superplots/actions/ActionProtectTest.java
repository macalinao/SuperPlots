...
public class ActionProtectTest {
    private SuperPlots main;
    private ActionProtect action;
    ...
    public void test_perform_alreadyProtected() {
        ...
        verify(player).sendMessage(contains("is already protected"));
    }
    ...
    public void test_perform_success() {
        ...
        verify(player).sendMessage(contains("has been protected"));
        verify(plot).setProtected(true);
    }
